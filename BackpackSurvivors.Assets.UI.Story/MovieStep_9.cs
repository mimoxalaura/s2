...
internal class MovieStep_9 : MovieStep
{
	[SerializeField]
	private AudioClip _crumblingBuildingAudioclip;
	...
	private IEnumerator PlayMovieStep()
	{
		...
		SingletonController<AudioController>.Instance.PlaySFXClip(_crumblingBuildingAudioclip, 0.5f);
