...
internal class BurrowOnPercentageDamageTakenTrigger : MonoBehaviour, IEnemyEventTriggerable
{
	[SerializeField]
	...
	public Enums.Enemies.EnemyTriggerType EnemyTriggerType => Enums.Enemies.EnemyTriggerType.PercentageDamaged;
