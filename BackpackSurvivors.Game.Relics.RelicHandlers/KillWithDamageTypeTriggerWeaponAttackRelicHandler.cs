...
internal class KillWithDamageTypeTriggerWeaponAttackRelicHandler : RelicHandler, IDPSLoggagable
{
	[SerializeField]
	private WeaponSO _weaponSOExplosion;

	[SerializeField]
	private Enums.DamageType _damageTypeToTriggerOn;
	...
	{
		if (e.DamageType == _damageTypeToTriggerOn)
		{
			float num = 1f;
			float num2 = 1f;
