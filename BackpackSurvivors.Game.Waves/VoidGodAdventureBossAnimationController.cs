...
internal class VoidGodAdventureBossAnimationController : AdventureBossAnimationController
{
	[SerializeField]
	...
	public override void Animate(Action onCancelOrFinish, Enemy enemy)
	{
		...
		StartCoroutine(AnimateAsync(_enemy));
	}
	...
	private IEnumerator AnimateAsync(VoidGod enemy)
	{
		FocusOnBoss();
