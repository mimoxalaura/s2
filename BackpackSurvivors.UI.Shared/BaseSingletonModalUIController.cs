...
public class BaseSingletonModalUIController<T> : SingletonController<T>, IModelUIController where T : MonoBehaviour
{
	...
	public event BaseModalUIController.CloseButtonClickedHandler OnCloseButtonClicked;
